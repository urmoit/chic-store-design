...
const translations = {
  en: {
    ...
    'footer.faq': 'FAQ',
    'footer.copyright': '© 2024 ChillHous. All rights reserved.',
    ...
    'contact.emailValue': 'hello@chillhous.com',
    'contact.phoneLabel': 'Phone',
    'contact.phoneValue': '+1 (555) 123-4567',
    'contact.addressLabel': 'Address',
    'contact.addressValue': '123 Style Street, Fashion District, NY 10001',
    ...
    'faq.a1': 'We offer a 30-day return policy on all unworn items with original tags attached. Simply contact our support team to initiate a return.',
    'faq.q2': 'How long does shipping take?',
    'faq.a2': 'Standard shipping takes 5-7 business days within the US. Express shipping (2-3 business days) is available at checkout. International shipping times vary by location.',
    ...
    'faq.a8': 'You can reach our support team via email at hello@chillhous.com or through our Contact page. We typically respond within 24 hours.',
  ...
  et: {
    ...
    'footer.help': 'Abi',
    'footer.contactUs': 'Võta ühendust',
    'footer.shippingInfo': 'Tarneinfo',
    'footer.returns': 'Tagastused',
    'footer.faq': 'KKK',
    'footer.copyright': '© 2024 ChillHous. Kõik õigused kaitstud.',
    ...
    'contact.subtitle': 'Meil on hea meel sinust kuulda',
    'contact.getInTouch': 'Kirjuta meile',
    'contact.name': 'Nimi',
    ...
    'contact.success': 'Sõnum edukalt saadetud!',
    'contact.info': 'Kontaktandmed',
    'contact.emailLabel': 'E-post',
    'contact.emailValue': 'tere@chillhous.ee',
    'contact.phoneLabel': 'Telefon',
    'contact.phoneValue': '+372 5123 4567',
    'contact.addressLabel': 'Aadress',
    'contact.addressValue': 'Viru 15, 10140 Tallinn, Eesti',
    'contact.hoursLabel': 'Lahtiolekuajad',
    ...
    'faq.a1': 'Pakume 30-päevast tagastusõigust kõigile kandmata toodetele, millel on originaalsildid küljes. Tagastuse alustamiseks võta ühendust meie klienditoega.',
    'faq.q2': 'Kui kaua tarne aega võtab?',
    'faq.a2': 'Standardtarne võtab Eestis 2-4 tööpäeva. Ekspressarne (1-2 tööpäeva) on saadaval tellimuse vormistamisel.',
    ...
    'faq.a8': 'Saad meie klienditoega ühendust võtta e-posti teel aadressil tere@chillhous.ee või meie kontaktilehe kaudu. Vastame tavaliselt 24 tunni jooksul.',
    'faq.stillQuestions': 'On veel küsimusi?',
    'faq.contactUs': 'Võta ühendust',
  },
};
