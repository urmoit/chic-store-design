...
const translations = {
  ...
  et: {
    ...
    'hero.title1': 'OLE',
    'hero.title2': 'CHILL',
    'hero.description': 'Premium tänavamood ja igapäevased riided. Disainitud mugavuseks, loodud stiiliks.',
    ...
    'cart.checkoutError': 'Tellimuse vormistamine pole hetkel saadaval. Palun proovi uuesti.',
    ...
    // Footer
    'footer.description': 'Premium tänavamood ja igapäevased riided. Disainitud mugavuseks, loodud stiiliks. Liitu liikumisega.',
    'footer.shop': 'Pood',
    'footer.allProducts': 'Kõik tooted',
    'footer.hoodies': 'Kapuutsid',
    ...
    'about.story': 'ChillHous sündis lihtsast ideest: luua riideid, mis tunduvad seljas sama hästi kui nad välja näevad. Me usume eneseväljendusse läbi moe ja meie missioon on pakkuda kvaliteetset tänavamoe riietust, mis laseb sul olla sina ise.',
    'about.mission.title': 'Meie missioon',
    'about.mission.text': 'Luua jätkusuutlikku, kvaliteetset tänavamoe riietust, mis võimaldab inimestel väljendada oma unikaalset stiili, tehes samal ajal planeedile head.',
    ...
    'faq.a4': 'Kui su tellimus on teele saadetud, saad e-kirja jälgimisnumbriga. Tellimuse kohta saad küsida ka aadressil chilli@chillhous.com.',
    ...
    'faq.a7': 'Kinkekaardid tulevad peagi! Jälgi meid sotsiaalmeedias, et olla kursis uudistega.',
